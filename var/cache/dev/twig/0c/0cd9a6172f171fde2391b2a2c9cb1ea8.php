...
$context["label"] == "danger")) {
    ...
    ";
        // line 41
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["specials"]) || array_key_exists("specials", $context) ? $context["specials"] : (function () { throw new RuntimeError('Variable "specials" does not exist.', 41, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 42
            ...
            // line 54
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["specials"]) || array_key_exists("specials", $context) ? $context["specials"] : (function () { throw new RuntimeError('Variable "specials" does not exist.', 54, $this->source); })()));
...
";
    ...
    {
        return array (  286 => 124,  276 => 117,  268 => 111,  261 => 106,  242 => 93,  233 => 87,  225 => 82,  220 => 79,  216 => 77,  210 => 75,  208 => 74,  202 => 71,  196 => 67,  190 => 64,  186 => 62,  180 => 60,  178 => 59,  172 => 55,  168 => 54,  154 => 42,  152 => 41,  142 => 34,  138 => 33,  128 => 26,  123 => 23,  120 => 21,  114 => 20,  104 => 17,  100 => 15,  96 => 13,  94 => 12,  91 => 11,  89 => 10,  86 => 9,  84 => 8,  79 => 7,  74 => 6,  69 => 5,  67 => 4,  57 => 3,  40 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"d-flex justify-content-between align-items-center mb-4\">
        ...
        <div>
            ...
            <ul class=\"dropdown-menu dropdown-menu-end mt-2\">
                <li><a class=\"dropdown-item\" href=\"{{ path('chefs_list') }}\"><i class=\"fas fa-user-tie me-2\"></i>Chefs</a></li>
                <li><a class=\"dropdown-item\" href=\"{{ path('contact_index') }}\"><i class=\"fas fa-envelope me-2\"></i>Contacts</a></li>
                <li><hr class=\"dropdown-divider\"></li>
                <li><a class=\"dropdown-item\" ><i class=\"fas fa-sign-out-alt me-2\"></i>Déconnexion</a></li>
            </ul>
        </div>
...
{% endblock %}
", "special/index.html.twig", "C:\\Users\\21658\\Desktop\\1erCycleStage\\3A1Cycle\\templates\\special\\index.html.twig");
    }
}
